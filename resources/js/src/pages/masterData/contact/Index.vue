        ...
        <div class="card shadow mb-4">
            <div class="card-title">
                <div class="mt-3 d-flex justify-content-between">
                    ...
                    <router-link to="/app/master-data/contact/create/form">
    ...
    export default {
        ...
        methods: {
            async getData() {
                try {
                    this.$vs.loading()
                    this.contacts = await this.$axios.get(`api/master-data/contact`)
            ...
            async handleArchive(p) {
                Swal.fire({
                    ...
                    if(result.isConfirmed == true){
                        this.$vs.loading()
                        this.$axios.get(`api/master-data/contact/${p.id}/archive`).then((response)=>{
                            this.$vs.loading.close()
                            if(response.status){
                                Swal.fire({
                                    icon: 'success',
