                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="form-group">
                                ...
                                <textarea v-model="formData.description" cols="30" rows="5" class="form-control" placeholder="Describe your product here for detail"></textarea>
                            </div>
                        </div>
                    </div>
                    <hr class="mb-2">
                    ...
                    <div v-if="formData.is_sale" class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <v-select v-model="formData.sale_account_id" :options="accountPendapatans" :reduce="p => p.id" style="width: 100%" label="account_code">
                                    <span slot="no-options">Account not found</span>
                                </v-select>
                            </div>
                        </div>
    ...
    export default {
        ...
        methods: {
            ...
            async getData() {
                try {
                    this.$vs.loading()
                    const resp = await this.$axios.get(`api/master-data/product/${this.$route.params.type}/detail`)
                    ...
                    if (!resp.status) {
                        Swal.fire({
                            ...
                            this.$router.push(`/app/master-data/product`);
                        })
                        return
                    }
            ...
            async handleSubmit() {
                try {
                    ...
                    this.$vs.loading()
                    const resp = await this.$axios.post(`api/master-data/product`,
                        formData, {
                            headers: {
