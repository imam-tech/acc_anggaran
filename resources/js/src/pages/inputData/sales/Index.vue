        ...
        <div class="card shadow mb-4">
            <div class="card-title">
                <div class="mt-3 d-flex justify-content-between">
                    ...
                    <router-link to="/app/input-data/sales/create/form">
            ...
            <div class="card-body">
                    ...
                    <div class="col-lg-6 col-xl-2">
                        <!--<div class="form-group">-->
                            <!--<label>Customer<span style="-->
                                    ...
                                    <!--font-style: italic;-->
                                <!--">*) required</span></label>-->
                            <!--<select class="form-control" v-model="formFilter.customer">-->
                ...
                <div class="table-responsive">
                    <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tr v-else v-for="(s, sI) in sales" :key="sI">
    ...
    export default {
        ...
        methods: {
            ...
            async handleGetData() {
                try {
                    this.$vs.loading()
                    const salesLocal = await this.$axios.get(`api/input-data/sales?page=${this.page}&` + new URLSearchParams(this.formFilter).toString())
                    const respSum = await this.$axios.get(`api/input-data/sales/summarize-count`)
                    ...
                    this.perPage = salesLocal.per_page
