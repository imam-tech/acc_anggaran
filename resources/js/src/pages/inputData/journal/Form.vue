    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-title">
                ...
                <router-link to="/app/input-data/journal" class="btn btn-success float-right mt-3 mr-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="input-group">
                                ...
                                <input type="datetime-local" class="form-control" v-model="formData.transaction_date" required />
                            </div>
                        </div>
                        <div class="col-md-6 col-xl-4">
                            <div class="input-group">
                                ...
                                <select class="form-control" v-model="formData.project_id" required>
        ...
        methods: {
            async getData() {
                try {
                    ...
                    const projLocals = await this.$axios.get(`api/project?company_id=${Cookies.get('current_company_fat')}`)
            ...
            async submitProcess() {
                try {
                    this.$vs.loading()
                    const respSave = await this.$axios.post('api/input-data/journal', this.formData)
                    this.$vs.loading.close()
                    if (!respSave.status) {
                        Swal.fire({
                            position: 'top-end',
                        ...
                        Swal.fire({
                            ...
                            this.$router.push(`/app/input-data/journal/${respSave.data.id}/detail`);
                        })
                    }
                } catch (e) {
                    this.$vs.loading.close()
            ...
            async initiateData() {
                try {
                    ...
                    if (this.$route.params.id !== 'create') {
                        const detailData = await this.$axios.get(`api/input-data/journal/${this.$route.params.id}/detail`)
                        ...
                        if (detailData.data.approved_at !== null || detailData.data.rejected_at !== null) {
                            ...
                            Swal.fire({
                                ...
                                this.$router.push('/app/input-data/journal')
                            })
                            return
                        }
