        ...
        <div class="card shadow mb-4">
            <div class="card-title">
                <div class="mt-3 d-flex justify-content-between">
                    ...
                    <router-link to="/app/input-data/purchase/create/form">
    ...
    export default {
        ...
        methods: {
            ...
            async handleGetData() {
                try {
                    this.$vs.loading()
                    const purchaseLocal = await this.$axios.get(`api/input-data/purchase?page=${this.page}&` + new URLSearchParams(this.formFilter).toString())
                    ...
                    const respSum = await this.$axios.get(`api/input-data/purchase/summarize-count`)
