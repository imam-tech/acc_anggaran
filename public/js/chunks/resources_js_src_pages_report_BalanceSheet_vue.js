...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      dataReports: [],
      lastMonth: 0,
      currentCompany: js_cookie__WEBPACK_IMPORTED_MODULE_0__["default"].get('current_company')
    };
  },
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              respData.posting.forEach(function (x) {
                var type = 'parent';
                if (month == "01") {
                  var respCl = {
                    "type": 'bold',
...
var render = function render() {
  ...
  return _c("div", {
    ...
    attrs: {
      href: "/print/balance-sheet?company_id=" + _vm.currentCompany,
      target: "_blank"
    }
    ...
    return _c("tr", {
      ...
      "class": cl.type === "bold" ? "font-weight-bold bg-light" : "pl-4"
